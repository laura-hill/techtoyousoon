...
provider "aws" {
  ...
  region = "us-east-1"
  #profile = "" # if not using the default profile
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  key_name = "aws-laura"
  security_groups = ["laura-sg-203"]
  tags = {
    "Name" = "lauras-Web Server of Bookstore"
  }
  user_data = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          TOKEN="................................"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/laura-hill/bookstore_rep/main/"
          ...
          docker-compose up -d
          EOF
  depends_on = [github_repository.my-repo, github_repository_file.app-files]
}
