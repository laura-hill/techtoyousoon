...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cbnre06bzyxe.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonelaurablog' # please enter your s3 bucket name
